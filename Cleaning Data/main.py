...
df = pd.read_csv('C:/Users/admin/Documents/vs/data analysis/Cleaning Data/AB_NYC_2019.csv')
...
df_clean.to_csv('C:/Users/admin/Documents/vs/data analysis/Cleaning Data/NYC_Airbnb_Cleaned.csv', index=False)
...
plt.tight_layout()
plt.savefig('C:/Users/admin/Documents/vs/data analysis/Cleaning Data/data_cleaning_results.png', dpi=300, bbox_inches='tight')
plt.show()
